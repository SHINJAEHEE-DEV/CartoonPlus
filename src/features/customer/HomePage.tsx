...
export function HomePage(){
  ...
  return <>
    ...
    <section className="feature-section"><p className="section-kicker">WHAT TO ENJOY</p><h2>네 가지 방식으로<br/>쉬어 가세요.</h2><div className="feature-grid"><a href="/books"><b>01</b><strong>도서 검색</strong><span>서가 위치와 보유 권수를 확인해요.</span><em>도서 찾기 →</em></a><a href="/games"><b>02</b><strong>즐길거리</strong><span>검증된 게임 목록을 안내해요.</span><em>게임 보기 →</em></a><a href="/menu"><b>03</b><strong>메뉴·요금</strong><span>확인된 이용 정보를 확인해요.</span><em>메뉴 보기 →</em></a><a href="/store"><b>04</b><strong>매장 안내</strong><span>오시는 길과 이용 가이드를 봐요.</span><em>매장 보기 →</em></a></div></section>
