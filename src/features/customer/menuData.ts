...
export const BEVERAGE_ITEMS: BeverageItem[] = [
  ...
  {
    id: 'b-hot-royal-milktea-latte',
    nameKo: '따뜻한 로얄밀크티 라떼',
    nameEn: 'HOT ROYAL MILK TEA LATTE',
    temp: 'HOT',
    subCategory: 'LATTE',
    packageDiff: 800,
    singlePrice: 4800,
  ...
  {
    id: 'b-iced-royal-milktea-latte',
    nameKo: '아이스 로얄밀크티 라떼',
    nameEn: 'ICED ROYAL MILK TEA LATTE',
    temp: 'ICED',
    subCategory: 'LATTE',
    packageDiff: 800,
    singlePrice: 4800,
  ...
  {
    id: 'b-hot-zero-milktea-latte',
    nameKo: '따뜻한 제로밀크티 라떼',
    nameEn: 'HOT ZERO MILK TEA LATTE',
    temp: 'HOT',
    subCategory: 'LATTE',
    packageDiff: 800,
    singlePrice: 4800,
  ...
  {
    id: 'b-iced-zero-milktea-latte',
    nameKo: '아이스 제로밀크티 라떼',
    nameEn: 'ICED ZERO MILK TEA LATTE',
    temp: 'ICED',
    subCategory: 'LATTE',
    packageDiff: 800,
    singlePrice: 4800,
...
export const FOOD_ITEMS: MenuItem[] = [
  // 1. 라면 & 식사류 (MEAL)
  {
    ...
    category: 'meal',
    categoryKo: '라면/음식',
    note: '대파·콩나물·청양고추·떡사리·만두·비엔나소시지·치즈·어묵 8종 토핑 바 무료',
    isPopular: true,
  },
  {
    id: 'f-chicken',
  ...
  { id: 'f-sotteok', name: '소떡소떡', price: 3000, category: 'meal', categoryKo: '라면/음식' },
