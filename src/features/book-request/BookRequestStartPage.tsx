      ...
      >
        ...
        <div>
          ...
          <p style={{ fontSize: '15px', fontWeight: 700, color: '#1E1E1E', marginTop: '12px' }}>
            <span style={{ color: '#8A6A00', fontWeight: 900 }}>“{title || '찾으시는 도서'}”</span>{' '}
            입고를 신청하시겠습니까?
          </p>
          <p
            style={{
          ...
          >
            개인정보는 수집하지 않으며, 남겨주신 도서 정보는 매장 담당자가 정기 입고 시 우선
            검토합니다.
          </p>
        </div>
        ...
        >
          <a className="primary-btn" href={`/book-request-form?title=${encodeURIComponent(title)}`}>
            신청서 작성하기 →
          </a>
          <a
            href="/books"
