...
export function StoreContentPage() {
  ...
  const handleTogglePopularPackage = (index: number) => {
    const updated = packages.map((pkg, idx) =>
      idx === index ? { ...pkg, isPopular: !pkg.isPopular } : pkg
    );
    void savePackagesToStorage(updated);
          ...
          >
            ...
            >
              ...
              <div style={{ gridColumn: 'span 2' }}>
                ...
                <input
                  name="note"
                  placeholder="예: 기본 음료 포함 · 초과 10분당 600원"
                  style={{
                    width: '100%',
                    padding: '10px 12px',
                    borderRadius: '10px',
              ...
              <div
                style={{ display: 'flex', alignItems: 'center', gap: '8px', paddingBottom: '8px' }}
              >
                <label
                  style={{
                    display: 'flex',
      ...
      {activeTab === 'beverages' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '22px' }}>
          ...
          >
            ...
            >
              <div style={{ fontSize: '18px', fontWeight: 900 }}>
                음료 메뉴 ({filteredBeverages.length}종)
              </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        {bev.packageDiff === 0
                          ? '+0원 (기본)'
                          : `+${bev.packageDiff.toLocaleString()}원`}
                      </span>
                    </div>

                    <div style={{ fontSize: '15px', fontWeight: 900, color: '#1E1E1E' }}>
                      {bev.nameKo}
                    </div>
                    {bev.nameEn && (
                      <div style={{ fontSize: '11px', fontWeight: 600, color: '#8A8175' }}>
                        {bev.nameEn}
                      </div>
                    )}
                    <div
      ...
      {activeTab === 'foods' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '22px' }}>
          ...
          >
            ...
            >
              <div style={{ fontSize: '18px', fontWeight: 900 }}>
                식사·디저트·스낵 상품 ({filteredFoods.length}종)
              </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <textarea
                  name="directions"
                  defaultValue={storeInfo.directions}
                  rows={2}
                  style={{
                    width: '100%',
                    padding: '12px',
              ...
              <div>
                ...
                <input
                  name="parking"
                  defaultValue={storeInfo.parking}
                  style={{
                    width: '100%',
                    padding: '12px',
                    borderRadius: '10px',
