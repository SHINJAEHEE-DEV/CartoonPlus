...
- **원클릭 & 예약 매장 안내 방송**: 정적 고음질 음원(.wav/.mp3) 6종 및 직원 업로드 음성 파일 기반 매장 전용 프리셋, 매일/요일별/1회성 예약 방송 및 실행 기록(Broadcast Run) 관리.
...
- **직원/관리자 콘솔**:
  ...
  - 매장 안내 방송 (정적 오디오 음원 및 업로드 음성 파일 프리셋, 예약 스케줄러, 방송 실행 기록 및 지점 격리)
