...
- **직원 진입·로그인 유지**: 공개 로그인 버튼을 제거하고 로고 3초 길게 누르기로 진입한다. 매장 전용 PC와 직원 개인 기기에서 유효한 세션을 복원하고 명시적 로그아웃을 제공한다. 상세 기준은 `docs/REQUIREMENTS.md` FR-AUTH-003, FR-AUTH-007을 따른다.
