-- Book corrections are scoped to the selected inventory and never matched by title or author.
alter table public.books drop constraint if exists books_title_author_key;
...
begin
  ...
  select store_id, book_id into v_store_id, v_book_id
